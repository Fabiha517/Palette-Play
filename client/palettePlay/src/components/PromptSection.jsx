	...
	return (
		<div className="rounded-3xl border border-[#E8D8C7] bg-[#FFF8F1] p-5  mb-8 ">
			...
			<textarea
				...
				ref={ref}
				placeholder="Example: serene evening, cool blue tones, light from the moon, magical atmosphere..."
				className={`
        ...
        `}></textarea>
			...
			<div className="mt-3 flex items-center justify-between">
				<div className="flex gap-4 pl-4 w-full">
					<button
						className=" px-5 py-3 w-[60%] lg:w-[35%] rounded-2xl text-white font-medium bg-linear-to-r from-[#D96A57] to-[#7C6AE8] hover:scale-[1.02] transition cursor-pointer"
